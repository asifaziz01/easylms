                    ...
                    <div class="d-flex flex-grow-1 min-width-zero">
                        ...
                        <div class=" mb-1 align-self-center pr-4">
								...
								if ($row['recording_for_students'] == 'true') {
									echo anchor ('student/virtual_class/recordings/'.$coaching_id.'/'.$row['class_id'].'/'.$row['meeting_id'].'/'.$row['course_id'].'/'.$row['batch_id'].'/'.$member_id, '<i class="fa fa-play"></i> Recordings', ['class'=>'btn btn-link link-text-color mr-1']);
								}
								?>
                        </div>
                    </div>
