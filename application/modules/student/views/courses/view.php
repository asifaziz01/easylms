           		...
           		<?php } else { ?>
	            	<?php if ($course['enrolment_type'] == COURSE_ENROLMENT_DIRECT) { ?> 
            			<div class="text-center mb-5">
		       				...
		       				<a class="btn btn-primary btn-lg mt-2 " href="<?php echo site_url('student/courses/enrol_in_course/'.$coaching_id.'/'.$member_id.'/'.$course_id); ?>"><span>Enrol Now</span></a> 
		       			</div>
	            	<?php } else { ?>
								...
								if ($seats > 0) {
			        				...
			        				<div class="d-flex flex-row mb-3 pb-3 border-bottom">
			                            ...
			                            <div class="mt-2">
			                            	...
			                            	?>
			                                <?php if ($seats > 0) { ?>
					            				<a class="btn btn-primary btn-xs" href="<?php echo site_url('student/courses/enrol_in_course/'.$coaching_id.'/'.$member_id.'/'.$course_id.'/'.$batch['batch_id']); ?>">Enrol Now</a>
											<?php } ?>
										</div>
			                        </div>
								<?php 
